...
describe ProfilesController, :type => :controller do
  ...
  let(:valid_attributes) { { "bio" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved profile as @profile" do
        ...
        post :create, {:profile => { "bio" => "invalid value" }}, valid_session
        expect(assigns(:profile)).to be_a_new(Profile)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested profile" do
        ...
        expect_any_instance_of(Profile).to receive(:update).with({ "bio" => "MyText" })
        put :update, {:id => profile.to_param, :profile => { "bio" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the profile as @profile" do
        ...
        put :update, {:id => profile.to_param, :profile => { "bio" => "invalid value" }}, valid_session
        expect(assigns(:profile)).to eq(profile)
      end
